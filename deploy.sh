...
# ==============================================================================
# [DEPRECATED] 수동 배포 스크립트 (ConoHa 서버용)
# ==============================================================================
# ⚠️  이 스크립트는 더 이상 사용되지 않습니다.
#     Issue #92 에서 GitHub Actions 자동 배포로 전환되었습니다.
#     배포는 .github/workflows/deploy-backend.yml 을 통해 자동으로 실행됩니다.
#
