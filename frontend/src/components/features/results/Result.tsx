...
export default function Result({ resultData, onReset }: ResultProps) {
  ...
  return (
    <>
      ...
      <div ref={contentRef} className="print-layout" style={{
        minHeight: '100vh',
        maxWidth: '794px',
        margin: '0 auto',
        display: 'flex',
        ...
        {/* ──── Main Content: Two-Column Grid (Printed Area) ──── */}
        <div style={{ width: '100%', padding: '0 10px' }}>

          <main className="result-main" style={{ maxWidth: '794px', margin: '0 auto', position: 'relative', zIndex: 10, width: '100%' }}>
            ...
            <div className="result-grid">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                ...
                <div className="hide-on-pdf" style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '16px' }}>
                  ...
                  >
                    {isGeneratingPdf ? '準備中...' : '詳細な鑑定書をダウンロード (PDF)'}
                  </button>
                  <button
                    onClick={onReset}
                    style={{
