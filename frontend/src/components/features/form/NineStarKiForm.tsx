        ...
        <Stack w="100%" gap="xs" styles={{ root: { gap: 'var(--mantine-spacing-xs)' } }}>
          ...
          {fortuneType === 'compatibility' ? (
            <Stack gap="xs">
              {/* あなたの情報 */}
              <Box>
                <Text fw="bold" size="sm" style={{ backgroundColor: 'rgba(212, 175, 55, 0.08)', padding: '3px 8px', borderRadius: '4px', color: COLORS.text }}>あなたの情報</Text>
                <Divider mt={0} mb={5} />
              ...
              {/* 相手の情報 */}
              <Box mt={5}>
                <Text fw="bold" size="sm" style={{ backgroundColor: 'rgba(216, 167, 167, 0.12)', padding: '3px 8px', borderRadius: '4px', color: COLORS.text }}>相手の情報</Text>
                <Divider mt={0} mb={5} />
