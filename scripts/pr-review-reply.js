...
const failedBatchOut = getFlag('--failed-batch-out', null, false);
const logFilePath = getFlag('--log-file', null, false);
const handledUrlsPath = getFlag('--handled-urls', null, false);
