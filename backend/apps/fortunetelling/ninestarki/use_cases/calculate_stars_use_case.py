...
from apps.fortunetelling.ninestarki.domain.services.star_calculator_service import StarCalculatorService
...
from apps.fortunetelling.numerology.domain.repositories.numerology_reading_repository_interface import (
    INumerologyReadingRepository,
)
from apps.fortunetelling.numerology.domain.value_objects.numerology import MASTER_TO_BASE
