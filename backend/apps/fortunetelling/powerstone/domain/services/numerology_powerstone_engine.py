...
from apps.fortunetelling.powerstone.domain.repositories.numerology_powerstone_repository_interface import (
    INumerologyPowerStoneRepository,
)
from apps.fortunetelling.numerology.domain.value_objects.numerology import MASTER_NUMBERS
